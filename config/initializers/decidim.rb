...
Decidim.configure do |config|
  ...
  # config.available_locales = ["bs", "ca", "cs", "de", "en", "es", "fr", "hr", "it", "nl", "pl", "pt", "ro", "el", "sl", "sr-CS", "tr-TR", "ar-SA", "fa-IR", "uk", "zh-TW"]
  config.available_locales = Rails.application.secrets.decidim[:available_locales].presence || ["bs", "ca", "cs", "de", "en", "es", "fr", "hr", "it", "nl", "pl", "pt", "ro", "el", "sl", "sr-CS", "tr-TR", "ar-SA", "fa-IR", "uk", "zh-TW"]
